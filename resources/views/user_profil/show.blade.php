                                                            ...
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    <label class="col-sm-2 col-form-label">Nama
                                                                        Lengkap</label> : {{ $user_profile->name }}
                                                                    <div class="col-sm-10">
                                                                    </div>
                                                                </div>
                                                                <div class="card">
                                                                    ...
                                                                    <div class="card">
                                                                        ...
                                                                        <div class="card">
                                                                            <div class="card-body">
                                                                                <!-- <td>
                                                                                    <label class="col-sm-2 col-form-label">Status</label> : {{ $pengaduan->status }}
@if($pengaduan->status == 0)
                                                                                    <a href="/pengaduan/status/{{ $pengaduan->id_pengaduan }}" class="btn btn-sm btn-primary" onClick="return confirm('Yakin ingin memproses data ini?')" readonly>Proses</a>
@else
...
@endif
                                                                            ...
                                                                            <div class="card">
                                                                                <div class="card-body">
                                                                                    <!-- <label class="col-sm-2 col-form-label">Foto</label> : {{ $pengaduan->foto }}
                                                                                    <td>
@php
...
@endforeach
                                                                            ...
                                                                            <div class="card">
                                                                                <div class="card-body">
                                                                                    <label
                                                                                        class="col-sm-2 col-form-label">RT</label>
                                                                                    : {{ $user_profile->rt }}
                                                                                    <div class="col-sm-10">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="card">
                                                                                    <div class="card-body">
                                                                                        <label
                                                                                            class="col-sm-2 col-form-label">RW</label>
                                                                                        : {{ $user_profile->rw }}
                                                                                        <div class="col-sm-10">
                                                                                        </div>
                                                                                    </div>
                                                                ...
                                                                <div
                                                                    ...
                                                                    <span
                                                                        ...
                                                                        © 2021. Premium <a
                                                                            ...
                                                                            target="_blank">Bootstrap admin template</a>
