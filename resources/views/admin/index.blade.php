        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="cetak-laporan">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="cetak-pengaduan">Pengaduan</a></li>
              </ul>
            </div>
          </li>
          @endif
                  ...
                  <div class="card mt-5">
                    ...
                    <div class="card-body">
                      ...
                      <td>{{ date('d F Y', strtotime($p->tgl_tanggapan)) }}</td> -->
                              ...
                              <!-- <td>{{ $p->nik }}</td>  -->
                              <td>
                                <a href="/user/edit/{{$p->id}}" class="btn btn-success">Edit</a>&nbsp;
                                <a href="/user/destroy/{{$p->id}}" class="btn btn-danger">Hapus</i></a>
                              </td>
                            </tr>
                            @endforeach
                          </tbody>
