        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item nav-profile dropdown">
            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
              ...
              <img src="https://cdn.iconscout.com/icon/premium/png-512-thumb/profile-1506810-1278719.png" alt="profile" / h6 class="font-weight-bold">&nbsp;&nbsp;<b>{{ Auth::user()->name }}</b></h6>
            </a>
      ...
      <div class="content-wrapper">
              ...
              <div class="content-wrapper">
                <div class="col-12 grid-margin stretch-card">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title">
                        <center>Silahkan Isi Terlebih Dahulu Pengaduanmu</center>
                      </h4>
                      <form method="post" action="/pengaduan/store" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                          ...
                          <p>
                          <h5>
                            <font color="red"> *Tambahkan laporan beserta alamat yang jelas dan lengkap* </font>
                          </h5>
                          </p>
        ...
        <footer class="footer">
          <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2023.Copyright © 2023. Pengaduan Masyarakat</span>
